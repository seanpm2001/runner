...
namespace GitHub.Runner.Common
{
    ...
    public sealed class HostContext : EventListener, IObserver<DiagnosticListener>, IObserver<KeyValuePair<string, object>>, IHostContext, IDisposable
    {
        ...
        public HostContext(string hostType, string logFile = null)
        {
            ...
            if (StringUtil.ConvertToBoolean(Environment.GetEnvironmentVariable("GITHUB_ACTIONS_RUNNER_INSECURE")))
            {
                _trace.Warning($"Runner is running under insecure mode: HTTPS server certifcate validation has been turned off by GITHUB_ACTIONS_RUNNER_INSECURE environment variable.");
            }
